<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        ...
        @else
            ...
            <li class="nav-item"><a href="{{ route('visitor.index') }}"><i class="la la-bookmark"></i><span class="menu-title" data-i18n="nav.navbars.main">Data Customer</span></a>
               
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-bookmark"></i><span class="menu-title" data-i18n="nav.navbars.main">Laporan</span></a>
