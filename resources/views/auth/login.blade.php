            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
                ...
                <div class="card-content">
                    ...
                    <form class="form-horizontal form-simple" action="{{ route('login') }}" method="POST" novalidate>
                        ...
                        <input type="text" class="form-control form-control-lg input-lg" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <input type="password" class="form-control form-control-lg input-lg"  @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
